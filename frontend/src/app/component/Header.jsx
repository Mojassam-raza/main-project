...
const Header = () => {
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <button className="inline-flex items-center bg-white text-blue-600 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base font-semibold mt-4 md:mt-0">
      Button
      <svg
        fill="none"
        stroke="currentColor"
